...
boolean CanChangeSkin(INT32 playernum)
{
	...
	if ((players[playernum].speed > 0 && !players[playernum].exiting) || (players[playernum].mo && !P_MobjWasRemoved(players[playernum].mo) && !P_IsObjectOnGround(players[playernum].mo)))
		return false;
